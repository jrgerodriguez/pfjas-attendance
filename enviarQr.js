...
<div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; max-width: 600px; margin: 40px auto; background-color: #f9f9f9; padding: 30px; border: 1px solid #dcdcdc; border-radius: 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.05);">
  ...
  <!-- TEXTO DEBAJO DEL QR -->
  <p style="font-size: 16px; color: #555555; line-height: 1.8; text-align: center; margin: 0 20px;">
    Este es tu <strong>código QR único</strong> para el <strong>Campamento JAS 2025</strong>.<br>
    Por favor, preséntalo al momento de ingresar para garantizar tu acceso.
  </p>

  <hr style="border: none; border-top: 1px solid #cfcfcf; width: 90%; margin: 30px auto;">
  ...
  <div style="text-align: center; margin-top: 30px; font-size: 12px; color: #aaaaaa;"></div>
</div>
